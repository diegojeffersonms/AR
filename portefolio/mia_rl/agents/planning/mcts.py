...
class MCTSNode:
    ...
    def backpropagate(self, value: float) -> None:
        ...
        if self.parent is not None:
            self.parent.backpropagate(-value)  # flip sign for opponent's perspective
...
class MCTSAgent:
    ...
    def _rollout(self, state: TicTacToeState, player: int) -> float:
        ...
        # Implement the random rollout (default rollout policy).
        #
        # Steps:
        ...
        #
        # Return the outcome from the original ``player``'s perspective.
        #
